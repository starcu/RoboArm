...
void SimpleSocketClient::createSocket()
{
    ...
    {
        throw std::runtime_error("CLIENT_SOCKET_CREATION_FAILED_EXIT_FAILURE");
        //return -1;
    }
    ...
    {
        throw std::runtime_error("CLIENT_INCORRECT_ADDRESS_EXIT_FAILURE");
        //return -1;
    }
}
...
void SimpleSocketClient::sendRequestToServer()
{
    ...
    {
       throw std::runtime_error("CLIENT_CONNECTION_FAILED_EXIT_FAILURE");
        //return -1;
    }
